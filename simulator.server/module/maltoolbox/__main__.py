...
---------
    ...
    <lang_file>     Path to .json, .yaml, .yml, .mar or .mal language file.
...
Notes:
-----
    - <lang_file> can be a serialized language graph (.json/.yaml/.yml), a
      .mar file generated by the older MAL compiler, or a .mal file containing
      the DSL written in MAL.
